...
export const About = ({
	...
	const handleAutoImportPathMessage = useCallback((event: MessageEvent) => {
	...
	useEffect(() => {
		window.addEventListener("message", handleAutoImportPathMessage)
		return () => {
			window.removeEventListener("message", handleAutoImportPathMessage)
		}
	}, [handleAutoImportPathMessage])
